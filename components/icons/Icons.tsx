...
export const InfoIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm8.706-1.442c1.146-.573 2.437.463 2.126 1.706l-.709 2.836.042-.02a.75.75 0 01.67 1.34l-.042.022-1.121.448a1.125 1.125 0 00-1.218 1.218l.448 1.121.022.042a.75.75 0 01-1.34-.67l.02-.042-2.836-.709a1.875 1.875 0 00-1.706-2.126C3.999 12.331 4.93 11.04 6.173 10.557c1.243-.483 2.527.214 2.783 1.002z" clipRule="evenodd" />
  </svg>
);
